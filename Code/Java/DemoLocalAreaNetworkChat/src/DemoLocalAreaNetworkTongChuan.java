...
public class DemoLocalAreaNetworkTongChuan extends JFrame implements ActionListener,Runnable{
    //初始化控件对象
    ...
    private DemoLocalAreaNetworkTongChuan(){
        //初始化窗体参数
        setSize(300,200);
        setVisible(true);
...
//                    System.out.println();       //换行
    ...
    public static void main(String args[]){
        DemoLocalAreaNetworkTongChuan TongChuan = new DemoLocalAreaNetworkTongChuan();
        TongChuan.setTitle("铜川用户");
        TongChuan.validate();
    }
